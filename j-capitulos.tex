...
\subsection{Preprocesado de imágenes}
...
\subsubsection{Transformación de fotografías}
...
\subsubsection{Transformación de etiquetas}
...
\subsubsection{Exportación de datos finales}
...
\subsection{Entrenamiento de modelos de \textit{machine learning}}

Para las primeras pruebas se utilizó el framework \textit{TensorFlow y Keras} para poder realizar los diferentes modelos de \textit{Machine Learning} para reconocimiento de orientación de cabeza, utilizando la data obtenida de la base de datos de ICPR. 

\subsection{Ajuste de modelos preentreanados}
\subsection{Pruebas en tiempo real}
