...
\def \CAPseleccion {Selección de hardware y software}
\def \CAPbasesdatos {Bases de datos}
\def \CAPalgoritmos {Algoritmos para visión por computadora}
\def \CAPsimulaciones {Simulaciones}
\def \CAPpruebasfisicas {Pruebas físicas}
